...
#define HOMING_BUMP_DIVISOR { 15, 16, 8 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  35, 35 }, { 256,  35 }, { 265, 265 }, { 35, 265 }}
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_LOAD_UNLOAD_GCODES     X      // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.
